...
// WAD Judging brand palette (from the logo)
export const BRAND = {
  primary: "#A61E7A", // magenta/purple — silhouettes + wordmark
  primaryHover: "#C13B95",
  rainbow: ["#E23B33", "#EF7E1B", "#F4C020", "#3EA845", "#2A5CA9"],
} as const;
    ...
    <ConfigProvider theme={authTheme}>
      <div className="w-full bg-white text-slate-900 lg:flex lg:min-h-dvh">
        ...
        <section
          ...
          style={{
            backgroundImage:
              "linear-gradient(135deg,#8E1A63 0%,#7A1C74 45%,#4E1D6E 100%)",
          }}
        >
          <div className="pointer-events-none absolute -right-24 -top-24 h-80 w-80 rounded-full bg-white/15 blur-3xl" />
          <div className="pointer-events-none absolute -bottom-28 -left-20 h-80 w-80 rounded-full bg-fuchsia-300/20 blur-3xl" />
